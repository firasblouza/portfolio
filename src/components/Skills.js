...
const Skills = ({ startAnimation }) => {
  ...
  return (
    <section
      id="skills-section"
      className="flex flex-col justify-center items-center gap-4 p-5 w-full min-h-screen overflow-hidden bg-gradient-to-br from-white to-sky-200 dark:from-[#0F172A] dark:to-sky-900 text-[#0F172A] dark:text-white border-t-2 border-white">
